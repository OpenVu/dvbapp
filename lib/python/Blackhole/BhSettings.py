...
class DeliteSetupOSDConf2(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'green': self.saveMyosd,
         'back': self.close})
        self.updateList()
...
class DeliteSetupCronConf(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        ConfigListScreen.__init__(self, self.list)
        self['key_green'] = Label(_('Save'))
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'green': self.checkentry,
         'back': self.close,
         'yellow': self.vkeyb})
        self.updateList()

    def updateList(self):
        mychoices = [('None', _('None')),
...
class DeliteKernelModules(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'green': self.saveMyconf,
         'yellow': self.showMod,
         'back': self.close})
        self.updateList()
...
class BhSpeedUp(Screen, ConfigListScreen):
    ...
    def __init__(self, session, firstrun = False):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'red': self.close,
         'green': self.saveMypoints,
         'back': self.close})
        self.pluglist = [['Serviceapp', 'enigma2-plugin-systemplugins-serviceapp'],
